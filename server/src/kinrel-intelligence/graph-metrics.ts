// server/src/kinrel/graph-metrics.ts
//
// Kinrel — Pure graph computation module (no NestJS / Prisma dependencies).
//
...
export interface GraphEdge {
  ...
  // Kinrel Bug 1 fix: ISO-639-1 language tag the user chose for this
...
//
// Kinrel Bug 1 fix: We now prefer edge.languageTag (the ISO-639-1 code the
...
// families and forced the Kinrel colour palette to Steel Blue for everyone.
//
