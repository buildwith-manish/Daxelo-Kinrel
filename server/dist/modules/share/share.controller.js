...
let ShareController = class ShareController {
    ...
    async createShareableLink(userId, body) {
...
], ShareController.prototype, "createShareableLink", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:returntype", Promise)
], ShareController.prototype, "getShareStats", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ShareController.prototype, "getSharedCard", null);
