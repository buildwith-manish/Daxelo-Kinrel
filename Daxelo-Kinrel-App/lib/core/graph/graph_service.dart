...
class GraphService {
  ...
  /// maxDepth limits recursion depth; also guarded by visited set
  /// and iteration counter to prevent infinite recursion from cycles
  /// in the graph or excessively large family trees causing ANR.
  List<GraphPerson> getAncestors({
    ...
    void traverse(String id, int depth) {
      ...
      if (iterations++ > maxIterations) return; // Safety: prevent ANR from large graphs
