...
class _QuizScreenState extends ConsumerState<QuizScreen>
          ...
          return _PressDown(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: const BorderRadius.circular(22),
                border: Border.all(
                  color: isSelected
        ...
        children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _difficultyColor(quizState.session!.difficulty)
                      ...
                      child: const Text(
                        ...
                        style: const TextStyle(
                          ...
                          fontWeight: FontWeight.w600,
                          color:
                              _difficultyColor(quizState.session!.difficulty),
                        ),
                      ),
                    ),
                  ],
          ...
          Expanded(
            child: SingleChildScrollView(
              physics: const BouncingScrollPhysics(),
              padding: const EdgeInsets.symmetric(
                  horizontal: KinrelSpacing.base, vertical: 16),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Question type badge
            ...
            Container(
              ...
              child: const Center(
                child: trailingIcon != null
                    ? const Icon(trailingIcon, color: textColor, size: 16)
                    : const Text(
  ...
  Widget _buildNextButton(QuizStateData quizState) {
    final isLast = quizState.session != null &&
