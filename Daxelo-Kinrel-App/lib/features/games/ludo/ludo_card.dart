// lib/features/games/ludo/ludo_card.dart
//
// Ludo — preview card for the Family Detail screen.
...
class LudoCard extends ConsumerStatefulWidget {
  const LudoCard({super.key, required this.familyId});
  final String familyId;

  @override
  ConsumerState<LudoCard> createState() => _LudoCardState();
}

class _LudoCardState extends ConsumerState<LudoCard> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    final dlState = ref.watch(gameDownloadStatusProvider('ludo'));

    // Rose/red accent — distinct from prior games
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            context.push('/family/${widget.familyId}/ludo/lobby');
          },
          child: Padding(
