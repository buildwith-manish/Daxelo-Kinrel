// lib/features/games/chitmatch/chitmatch_card.dart
...
class ChitmatchCard extends ConsumerStatefulWidget {
  const ChitmatchCard({super.key, required this.familyId});
  final String familyId;

  @override
  ConsumerState<ChitmatchCard> createState() => _ChitmatchCardState();
}

class _ChitmatchCardState extends ConsumerState<ChitmatchCard> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    final dlState = ref.watch(gameDownloadStatusProvider('chitmatch'));
    const accent = Color(0xFFEC4899); // pink accent
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            context.push('/family/${widget.familyId}/chitmatch/lobby');
          },
          child: Padding(
