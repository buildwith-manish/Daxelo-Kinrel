// lib/features/games/nameplace/nameplace_card.dart
...
class NameplaceCard extends ConsumerStatefulWidget {
  const NameplaceCard({super.key, required this.familyId});
  final String familyId;

  @override
  ConsumerState<NameplaceCard> createState() => _NameplaceCardState();
}

class _NameplaceCardState extends ConsumerState<NameplaceCard> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(gameDownloadStatusProvider('nameplace').notifier).checkStatus());
  }

  @override
  Widget build(BuildContext context) {
    final dlState = ref.watch(gameDownloadStatusProvider('nameplace'));
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            context.push('/family/${widget.familyId}/nameplace/lobby');
          },
          child: Padding(
