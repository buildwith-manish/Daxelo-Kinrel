...
// ═══════════════════════════════════════════════════════════════════════
// Auspicious Event Type (for finder)
// ═══════════════════════════════════════════════════════════════════════

/// Types of auspicious events for the date finder.
enum AuspiciousEventType {
  wedding,
  grihaPravesh,
  namingCeremony,
  mundan,
...
/// A pending reminder for an upcoming event.
class PendingReminder {
  ...
  /// How many days until this reminder fires.
  int get daysUntil {
  ...
  /// Whether this reminder is currently due.
  bool get isDue => daysUntil <= 0 && !isDismissed;
  ...
  PendingReminder copyWith({bool? isDismissed}) {
...
// ═══════════════════════════════════════════════════════════════════════
// Auspicious Date Result
// ═══════════════════════════════════════════════════════════════════════

/// A result from the auspicious date finder.
class AuspiciousDateResult {
  const AuspiciousDateResult({
    required this.date,
...
class SmartCalendarEvent {
  ...
  /// Start time of event (hour 0-23)
  final int? startTime;

  /// End time of event (hour 0-23)
  final int? endTime;
  ...
  String get formattedTime {
    ...
    final s = startTime!;
    final e = endTime ?? s + 1;
    return '${_formatHour(s)} – ${_formatHour(e)}';
  }
...
/// calculations and hardcoded festival dates for 2024-2029.
class HinduPanchangService {
  ...
  // ── Festival Database (hardcoded for 2024-2029) ───────────────────
  static const List<({int year, int month, int day, String name})>
  _festivals = [
    // 2024
    ...
    // 2028
    (year: 2028, month: 1, day: 14, name: 'Makar Sankranti'),
    (year: 2028, month: 2, day: 24, name: 'Maha Shivaratri'),
    (year: 2028, month: 3, day: 11, name: 'Holi'),
    (year: 2028, month: 3, day: 28, name: 'Ugadi / Gudi Padwa'),
    (year: 2028, month: 4, day: 3, name: 'Ram Navami'),
    (year: 2028, month: 4, day: 10, name: 'Hanuman Jayanti'),
    (year: 2028, month: 7, day: 7, name: 'Guru Purnima'),
    (year: 2028, month: 7, day: 27, name: 'Raksha Bandhan'),
    (year: 2028, month: 8, day: 4, name: 'Krishna Janmashtami'),
    (year: 2028, month: 8, day: 24, name: 'Ganesh Chaturthi'),
    (year: 2028, month: 9, day: 16, name: 'Pitru Paksha Begins'),
    (year: 2028, month: 10, day: 1, name: 'Shardiya Navratri Begins'),
    (year: 2028, month: 10, day: 9, name: 'Maha Ashtami'),
    (year: 2028, month: 10, day: 10, name: 'Maha Navami'),
    (year: 2028, month: 10, day: 11, name: 'Dussehra / Vijayadashami'),
    (year: 2028, month: 10, day: 17, name: 'Sharad Purnima'),
    (year: 2028, month: 10, day: 29, name: 'Karwa Chauth'),
    (year: 2028, month: 11, day: 5, name: 'Dhanteras'),
    (year: 2028, month: 11, day: 7, name: 'Diwali (Lakshmi Puja)'),
    (year: 2028, month: 11, day: 8, name: 'Govardhan Puja'),
    (year: 2028, month: 11, day: 9, name: 'Bhai Dooj'),
    (year: 2028, month: 11, day: 12, name: 'Chhath Puja'),
    (year: 2028, month: 12, day: 25, name: 'Christmas'),

    // 2029
    (year: 2029, month: 1, day: 14, name: 'Makar Sankranti'),
    (year: 2029, month: 2, day: 13, name: 'Maha Shivaratri'),
    (year: 2029, month: 3, day: 1, name: 'Holi'),
    (year: 2029, month: 3, day: 17, name: 'Ugadi / Gudi Padwa'),
    (year: 2029, month: 3, day: 23, name: 'Ram Navami'),
    (year: 2029, month: 3, day: 30, name: 'Hanuman Jayanti'),
    (year: 2029, month: 6, day: 26, name: 'Guru Purnima'),
    (year: 2029, month: 7, day: 16, name: 'Raksha Bandhan'),
    (year: 2029, month: 8, day: 23, name: 'Krishna Janmashtami'),
    (year: 2029, month: 9, day: 13, name: 'Ganesh Chaturthi'),
    (year: 2029, month: 9, day: 25, name: 'Pitru Paksha Begins'),
    (year: 2029, month: 10, day: 9, name: 'Shardiya Navratri Begins'),
    (year: 2029, month: 10, day: 17, name: 'Maha Ashtami'),
    (year: 2029, month: 10, day: 18, name: 'Maha Navami'),
    (year: 2029, month: 10, day: 19, name: 'Dussehra / Vijayadashami'),
    (year: 2029, month: 10, day: 26, name: 'Sharad Purnima'),
    (year: 2029, month: 11, day: 7, name: 'Karwa Chauth'),
    (year: 2029, month: 11, day: 15, name: 'Dhanteras'),
    (year: 2029, month: 11, day: 17, name: 'Diwali (Lakshmi Puja)'),
    (year: 2029, month: 11, day: 18, name: 'Govardhan Puja'),
    (year: 2029, month: 11, day: 19, name: 'Bhai Dooj'),
    (year: 2029, month: 11, day: 22, name: 'Chhath Puja'),
    (year: 2029, month: 12, day: 25, name: 'Christmas'),
  ];
  ...
  // ── Auspicious nakshatras for different event types ────────────────
  static const List<String> _weddingNakshatras = [
    'Rohini',
    'Punarvasu',
    'Pushya',
    'Magha',
  ...
  static const List<String> _weddingYogas = [
    'Priti',
    'Ayushman',
    'Saubhagya',
    'Shobhana',
  ...
  static PanchangModel getPanchang(DateTime date) {
    ...
    final nakshatraIndex = ((dayOfYear + _nakshatraOffset(date.year)) % 27)
        .clamp(0, 26);

    // Yoga: similar cycle
    final yogaIndex = ((dayOfYear + _yogaOffset(date.year)) % 27).clamp(0, 26);

    // Karana
    final karanaIndex = ((dayOfYear * 2 + _karanaOffset(date.year)) % 11).clamp(
      0,
      10,
    );
    ...
    // Is auspicious
    final isAuspicious =
        _auspiciousTithiIndices.contains(tithiIndex % 15) ||
  ...
  /// Find auspicious dates for a specific event type.
  /// Returns the top 5 most auspicious dates starting from [fromDate].
  static List<AuspiciousDateResult> findAuspiciousDates(
    AuspiciousEventType eventType,
    DateTime fromDate,
  ) {
    final results = <AuspiciousDateResult>[];
    final checkDate = DateTime(fromDate.year, fromDate.month, fromDate.day);

    // Check up to 6 months ahead
    for (int i = 0; i < 180; i++) {
      final date = checkDate.add(Duration(days: i));
      // Skip Tuesdays and Saturdays for most events
      if (eventType != AuspiciousEventType.travel &&
      ...
      // Skip Amavasya
      final panchang = getPanchang(date);
      if (panchang.tithi.contains('Amavasya')) continue;

      int score = 0;

      // Base auspicious score
      if (panchang.isAuspicious) score += 30;
      if (panchang.festivals.isNotEmpty) score += 10;

      // Shukla paksha is generally better
      if (panchang.paksha == 'Shukla') score += 15;

      // Nakshatra scoring
      if (_weddingNakshatras.contains(panchang.nakshatra)) score += 25;

      // Yoga scoring
      if (_weddingYogas.contains(panchang.yoga)) score += 20;

      // Event-specific scoring
      switch (eventType) {
        case AuspiciousEventType.wedding:
          if (panchang.tithi.contains('Panchami') ||
              panchang.tithi.contains('Saptami') ||
              panchang.tithi.contains('Dashami') ||
              panchang.tithi.contains('Ekadashi') ||
              panchang.tithi.contains('Purnima')) {
            score += 10;
          }
          break;
        case AuspiciousEventType.grihaPravesh:
          if (panchang.tithi.contains('Pratipada') ||
              panchang.tithi.contains('Panchami') ||
              panchang.tithi.contains('Dashami')) {
            score += 15;
          }
          break;
        case AuspiciousEventType.namingCeremony:
          if (panchang.nakshatra == 'Ashwini' ||
              panchang.nakshatra == 'Rohini' ||
              panchang.nakshatra == 'Pushya' ||
              panchang.nakshatra == 'Hasta') {
            score += 20;
          }
          break;
        case AuspiciousEventType.mundan:
          ...
          break;
        case AuspiciousEventType.engagement:
          if (panchang.tithi.contains('Dashami') ||
              panchang.tithi.contains('Panchami')) {
            score += 15;
          }
          break;
        case AuspiciousEventType.upanayana:
          if (panchang.tithi.contains('Panchami') ||
              panchang.tithi.contains('Saptami') ||
              panchang.tithi.contains('Dashami')) {
            score += 15;
          ...
          break;
        case AuspiciousEventType.startingBusiness:
          if (panchang.tithi.contains('Pratipada') ||
              panchang.tithi.contains('Panchami') ||
              panchang.tithi.contains('Dashami') ||
              panchang.tithi.contains('Purnima')) {
          ...
          break;
        case AuspiciousEventType.travel:
          ...
          if (panchang.nakshatra == 'Pushya' ||
              panchang.nakshatra == 'Swati' ||
              panchang.nakshatra == 'Revati') {
            score += 15;
          }
          break;
      }
  ...
  static List<SmartCalendarEvent> getUpcomingFestivals({int days = 14}) {
    final now = DateTime.now();
    final results = <SmartCalendarEvent>[];
    for (int i = 0; i <= days; i++) {
      ...
      for (final f in festivals) {
        ...
        results.add(
          SmartCalendarEvent(
            id: 'upcoming-${f.year}-${f.month}-${f.day}-${f.name.hashCode}',
            title: f.name,
            date: DateTime(f.year, f.month, f.day),
            type: CalendarEventType.panchangFestival,
            description: '${f.name} — Hindu Festival',
...
class SmartCalendarState {
  ...
  /// Pending reminders for upcoming events.
  final List<PendingReminder> pendingReminders;
  ...
  /// Get non-dismissed pending reminders.
  List<PendingReminder> get activeReminders =>
      pendingReminders.where((r) => !r.isDismissed).toList();

  /// Count of active reminders (for badge).
  int get reminderBadgeCount => activeReminders.length;

  /// Get upcoming festivals within next 7 days.
  List<SmartCalendarEvent> get upcomingFestivalEvents {
    final now = DateTime.now();
    return events
        .where(
          (e) =>
              e.type == CalendarEventType.panchangFestival &&
              e.date.isAfter(now.subtract(const Duration(days: 1))) &&
              e.date.isBefore(now.add(const Duration(days: 8))),
        )
        .toList();
  }
  ...
  SmartCalendarState copyWith({
    ...
    List<PendingReminder>? pendingReminders,
  }) {
    return SmartCalendarState(
      ...
      panchangForSelectedDate: clearPanchang
          ? null
          : (panchangForSelectedDate ?? this.panchangForSelectedDate),
...
class SmartCalendarNotifier extends StateNotifier<SmartCalendarState> {
  ...
  void _initializeEvents() {
    ...
    final demoEvents = <SmartCalendarEvent>[
      ...
      SmartCalendarEvent(
        ...
        reminderTimings: [
          ReminderTiming.threeDaysBefore,
          ReminderTiming.oneDayBefore,
        ],
      ),
    ];
    ...
    final reminders = _computeReminders(demoEvents);
  ...
  /// Compute pending reminders from all events.
  List<PendingReminder> _computeReminders(List<SmartCalendarEvent> events) {
    final reminders = <PendingReminder>[];
    final now = DateTime.now();

    for (final event in events) {
      for (final timing in event.reminderTimings) {
        ...
        // Only include reminders that are upcoming (within 7 days) or due
        if (reminderTime.isAfter(now.subtract(const Duration(days: 1))) &&
            reminderTime.isBefore(now.add(const Duration(days: 8)))) {
          reminders.add(
            PendingReminder(
              eventId: event.id,
    ...
    // Sort by event date
    reminders.sort((a, b) => a.eventDate.compareTo(b.eventDate));
    return reminders;
  }
  ...
  void addEvent(SmartCalendarEvent event) {
    ...
    // Auto-set reminders for birthdays and anniversaries
    final effectiveEvent = _applyAutoReminders(event);
    if (effectiveEvent.reminderTimings != event.reminderTimings) {
      final idx = updatedEvents.indexWhere((e) => e.id == event.id);
      if (idx >= 0) updatedEvents[idx] = effectiveEvent;
    }
    final reminders = _computeReminders(updatedEvents);
    state = state.copyWith(events: updatedEvents, pendingReminders: reminders);
  }

  /// Apply auto-reminders for birthday/anniversary events.
  SmartCalendarEvent _applyAutoReminders(SmartCalendarEvent event) {
    if (event.type == CalendarEventType.birthday ||
        event.type == CalendarEventType.anniversary) {
      final timings = List<ReminderTiming>.from(event.reminderTimings);
      if (!timings.contains(ReminderTiming.oneWeekBefore)) {
        timings.add(ReminderTiming.oneWeekBefore);
      }
      if (!timings.contains(ReminderTiming.oneDayBefore)) {
        timings.add(ReminderTiming.oneDayBefore);
      }
      if (!timings.contains(ReminderTiming.morningOf)) {
        timings.add(ReminderTiming.morningOf);
      }
      return event.copyWith(reminderTimings: timings);
    }
    return event;
  }
  ...
  void dismissReminder(String eventId, ReminderTiming timing) {
    final updatedReminders = state.pendingReminders.map((r) {
      if (r.eventId == eventId && r.timing == timing) {
        return r.copyWith(isDismissed: true);
      }
      return r;
    }).toList();
    state = state.copyWith(pendingReminders: updatedReminders);
  }
  ...
  void loadFestivalsForMonth(int year, int month) {
    final festivals = HinduPanchangService.getFestivalsForMonth(year, month);
    final existingIds = state.events.map((e) => e.id).toSet();
    final newFestivals = festivals
        .where((f) => !existingIds.contains(f.id))
        .toList();
    if (newFestivals.isNotEmpty) {
      final updatedEvents = [...state.events, ...newFestivals];
      final reminders = _computeReminders(updatedEvents);
      state = state.copyWith(
...
/// Main provider for the smart calendar state.
