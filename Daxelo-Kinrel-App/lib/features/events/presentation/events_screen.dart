...
class _EventsScreenState extends ConsumerState<EventsScreen> {
  ...
  void initState() {
    super.initState();
    // CRITICAL ANR FIX: Removed timer-based setState. The provider
    // automatically handles countdown updates through ref.watch(),
    // no manual timer refresh needed. Timer + setState caused excessive
    // rebuilds triggering the main thread ANR with recursive loop.
  }
...
class _EventDetailScreenState extends ConsumerState<_EventDetailScreen> {
  ...
  void initState() {
    super.initState();
    // CRITICAL ANR FIX: Removed timer-based setState causing excessive rebuilds
    // The countdown display updates naturally through provider state changes
  }
