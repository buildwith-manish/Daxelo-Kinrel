...
void main() {
  group('P11.5 — Timeline scrub benchmark', () {
    test('filterMapPins with 500 pins < 5ms', () {
      ...
      final pins = List.generate(500, (i) => MapPin(
        personId: 'p$i',
        name: 'Member $i',
        city: 'City $i',
        photoUrl: null,
      ...
      debugPrint('P11.5 timeline_scrub_benchmark: '
    ...
    test('filterMapPlaces with 100 places < 5ms', () {
      ...
      final places = List.generate(100, (i) => FamilyPlace(
        id: 'place_$i',
        familyId: 'fam',
        name: 'Place $i',
    ...
    test('timelineCrossfade is 300ms (smooth at 60 FPS)', () {
      ...
      final frames = (MapVisualConstants.timelineCrossfade.inMilliseconds / 16.67).round();
