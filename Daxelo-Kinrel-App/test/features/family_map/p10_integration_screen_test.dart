...
''';
  ...
  group('Phase 10 Integration — hex mismatch fix (P10.8)', () {
    test('MapVisualConstants.buildingNormal matches style JSON #1A1B2E', () {
      // The audit found a cosmetic mismatch: constants said #1F1B2E
      // but the style JSON uses #1A1B2E. Verify the fix.
      expect(MapVisualConstants.hexBuildingNormal, equals('#1A1B2E'));
      // Verify the Color constant matches the hex string.
      const expected = Color(0xFF1A1B2E);
